        ...
        >
          ...
          <div className="space-y-4 py-6 text-left lg:ml-[150px]">
            ...
            <div className="text-lg md:text-xl text-zinc-400 space-y-4">
              ...
              <p>
                I am passionate about building scalable software, creating effective solutions, and learning every day to grow professionally in the field of technology. With a strong foundation in full-stack development, I have experience in various technologies and frameworks.
              </p>
              <p>
